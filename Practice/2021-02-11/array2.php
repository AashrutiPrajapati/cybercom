...
foreach ($data as $key => $value) {
    ...
    $final['category'][$value['category']]['attribute'][$value['attribute']]['attributename']=$value['attributename'];
    $final['category'][$value['category']]['attribute'][$value['attribute']]['option'][$value['option']]['optionname']=$value['optionname'];
